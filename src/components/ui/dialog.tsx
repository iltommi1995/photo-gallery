...
function DialogOverlay({
  ...
  fullscreen = false,
  ...props
}: DialogPrimitive.Backdrop.Props & { fullscreen?: boolean }) {
  return (
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          fullscreen
            ? "fixed inset-0 z-50 h-full w-full max-w-none rounded-none border-none bg-transparent text-sm text-popover-foreground outline-none"
